                ...
                if (f.verifyLogin(email, pass)) {
                    ...
                    do {
                        ...
                        if (choice == 1) f.viewDashboard();
                            ...
                            if (sIdx == -1) { 
                                cout << "[!] Error: Student " << roll << " not found in system.\n"; 
                                continue; 
                            }
                            
                            // NEW: Verify student belongs to this section
                            if (students[sIdx].getSection() != sec) {
                                cout << "[!] Error: Student belongs to Section " << students[sIdx].getSection() << ", not Section " << sec << ".\n";
                                continue;
                            }
                            ...
                            else { double amt; cout << "Enter amount to redeem: "; cin >> amt; f.redeemSalary(amt); }
                        }
